...
{
  return (Heap_Block *) ( (void *)base + offset );
}
...
RTEMS_INLINE_ROUTINE bool _Heap_Is_previous_block_free (
  Heap_Block *the_block
)
{
...
RTEMS_INLINE_ROUTINE bool _Heap_Is_block_free (
  Heap_Block *the_block
)
{
...
RTEMS_INLINE_ROUTINE bool _Heap_Is_block_used (
  Heap_Block *the_block
)
{
  return (the_block->front_flag & HEAP_BLOCK_USED);
...
RTEMS_INLINE_ROUTINE bool _Heap_Is_page_size_valid(
